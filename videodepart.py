...
# ============== 只需修改这里 ==============
# 配置参数
base_dir = "D:/study/work" #新建“test_vedio”文件夹用于存放视频，配置“test_vedio”所在路径
output_base = "D:/study/work/test_photo/" #配置输出文件夹所在路径
...
video_name = f"MB7_201HZ_200FPS_12_1.mp4" #设置所处理视频名称
